...
for zone in os.listdir('/Windows/System32'): # /usr/bin for lx and mac
    fileList.insert(tkinter.END, zone)

listScrow = tkinter.Scrollbar(mainWindow, orient=tkinter.VERTICAL, command=fileList.yview)
listScrow.grid(row=1, column=1, sticky='nsw', rowspan=2)
fileList['yscrollcommand'] = listScrow.set
